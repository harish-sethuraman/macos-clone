            ...
            fallback={(
              <div className="shimmer">
                <div className="nav-shimmer">
                  <div className="nav-icon-shimmer" />
                  <div className="left-shimmers">
                ...
                <div className="body-shimmer">
                  ...
                  <div className="name-holder">
                    <h1 className="name-shimmer"> Hey 👋 ! Im</h1>
                    <h1 className="name-shimmer">loading ;)</h1>
                  </div>

                  <h2 className="h2-shimmer">stay safe😷</h2>
                  <div className="icons-shimmer">
                    <div className="icon-shimmer" />
                    <div className="icon-shimmer" />
                    <div className="icon-shimmer" />
                  </div>
                  <button type="button" onClick={() => window.open('mailto:ssharishkumargmail.com?subject=Pinging from website')} className="button-shimmer">Ping me</button>
                </div>
              </div>
            )}
          >
